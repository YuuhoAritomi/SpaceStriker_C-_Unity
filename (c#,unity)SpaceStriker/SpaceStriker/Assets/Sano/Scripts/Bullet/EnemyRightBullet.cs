...
public class EnemyRightBullet : Bullet {

    [SerializeField]
    private int rightPower; // 右にカーブ
    private float speed;
    ...
    {
        GetComponent<Rigidbody>().AddForce(-rightPower, 0, 0, ForceMode.Impulse);
        trigger = true;
    }
    ...
    protected override void Move()
    {
        ...
        else
        {
            ...
            if (trigger)
            {
                GetComponent<Rigidbody>().AddForce(rightPower * magnification, 0, 0, ForceMode.Impulse);
                trigger = false;
            }
        }
    }
